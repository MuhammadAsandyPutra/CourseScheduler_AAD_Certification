...
class DetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.course.observe(this) { item ->
    ...
    private fun showCourseDetail(course: Course?) {
        course?.apply {
            ...
            val cNote : TextView = findViewById(R.id.tv_note)
            cNote.text = note

            val lecturerName: TextView = findViewById(R.id.tv_lecturer)
            lecturerName.text = lecturer

            val timeFormula : TextView = findViewById(R.id.tv_time)
            timeFormula.text = timeFormat
        }
    }
